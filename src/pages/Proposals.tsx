  ...
  <Tooltip>
    <TooltipTrigger asChild>
      <span
        ...
        className="absolute -top-1.5 -right-1.5 h-3.5 w-3.5 rounded-full bg-[#D97706] ring-2 ring-background"
      />
    </TooltipTrigger>
                  ...
                  <TableBody>
                    {displayedProposals.map((proposal) => (
                      ...
                      >
                        ...
                        {isAdmin && (
                          <TableCell className="text-center">
                            {typeof proposal.hallucination_score === 'number' ? (
                              <TooltipProvider>
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <div className="inline-flex items-center gap-1 text-sm font-semibold text-foreground cursor-default">
